...
Complete the first set of exercises in [this repo](https://github.com/ga-wdi-pvd/ruby-basics-exercises).

If you finish this section early, feel free to try out one of the [Additional Exercises](https://github.com/ga-wdi-pvd/ruby-intro#additional-practice) located at the bottom of the lesson plan.
...
Lets use `.object_id` to demonstrate that the above diagram is true.
...
Complete the second set of exercises in [this repo](https://github.com/ga-wdi-pvd/ruby-basics-exercises).
...
[Temperature Converter (Ruby)](https://github.com/ga-wdi-pvd/temperature_converter_ruby)
